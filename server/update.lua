...
Citizen.CreateThread( function()
    PerformHttpRequest("https://raw.githubusercontent.com/Niknock/NKHD_Plate_Switcher_V3/main/version", checkVersion, "GET")
end)